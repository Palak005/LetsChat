...
const Login = ()=>{
    ...
    return (
        <div className="w-screen h-screen bg-[#615D73] flex justify-center items-center" >
            <div className="w-1/2 h-3/5 bg-[#2C2638] rounded-3xl flex gap-0.5">
                ...
                <div className="h-full w-1/2 rounded-3xl flex flex-col items-center justify-evenly ">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 w-3/4 p-4">
                        <label htmlFor="username" className="w-full">
                            <span>Username</span>
                        <input id="username" 
                            type="text" placeholder="Type here" 
                            className="input bg-[#3C364C] input-bordered rounded-xl w-full max-w-xs" 
